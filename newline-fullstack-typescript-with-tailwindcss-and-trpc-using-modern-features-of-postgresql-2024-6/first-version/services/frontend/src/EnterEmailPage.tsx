...
import { SecondaryButton, PrimaryButton } from './shared-components/buttons';
import trpc from './trpc';

const EnterEmail: FC = () => {
  const { onGoBack, state, updateState } = useContext(bookingFlowContext);
  ...
  return (
    <div>
      <div className="text-2xl font-bold">Confirm and enter email address</div>
