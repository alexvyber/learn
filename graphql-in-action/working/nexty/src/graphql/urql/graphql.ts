...
export type EvenMoreShitQueryVariables = Exact<{ [key: string]: never; }>;


export type EvenMoreShitQuery = { result: { id: string } };
...
export const EvenMoreShitDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"EvenMoreShit"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","alias":{"kind":"Name","value":"result"},"name":{"kind":"Name","value":"someShit"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<EvenMoreShitQuery, EvenMoreShitQueryVariables>;