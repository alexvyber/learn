...
create table jungle(A int);
insert into jungle values(1),(2),(3),(4),(5);
select A from jungle;


update jungle set A=9 where A=3;
select A from jungle;


update jungle set A=76 where A=5;
select A from jungle;

update jungle set A=431 where A>5;
select A from jungle;
